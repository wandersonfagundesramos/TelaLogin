class Login {
    ...
    static endpoint = "https://indexjs.wanderson10.repl.co";
    //https://indexjs.wanderson10.repl.co/?matricula=123&senha=321
    ...
    static verificaLogin=()=>{
        ...
        const endpoint = `https://indexjs.wanderson10.repl.co/?matricula=${mat}&senha=${pas}`;
        fetch(endpoint)
        .then(res=>res.json())
        .then(res=>{
            if(res) {
